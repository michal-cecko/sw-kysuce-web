<section id="about-card">
    ...
    <div class="container">
        <div class="row">
            <?php $img = get_field("about-card_img_1", "options") ?>
            <?php if ($img) : ?>
                <div class="col-md-5">
            ...
            <div class="<?= $img ? "col-md-7" : "col-12" ?>">
                <div class="text-container">
                    <h4 class="heading on-black mb-5"><?= get_field("about-card_heading", "options") ?></h4>
                    <?php if ($text = get_field("about-card_text", "options")) : ?>
        ...
        <?php if ($img = get_field("about-card_img_2", "options")) : ?>
            <div class="abs-img-1">
                <img src="<?= $img ?>" alt="">
            </div>
        <?php endif ?>
